...
from flask_app.forms import (SearchForm, CatReviewForm)
...
def cat_detail(cat_name):
    ...
    return render_template('cat_detail.html', form=form, image=image_result[0], cat=breed_result[0], ratings=ratings, reviews=reviews)
